...
\definecolor{jdlKeyword}{HTML}{AF00DB}      % purple (entity, enum)
\definecolor{jdlRelation}{HTML}{D73A49}     % red/pink (relationships)
\definecolor{jdlType}{HTML}{267F99}         % teal (types)
\definecolor{jdlOption}{HTML}{795E26}       % brown (required, with)
\definecolor{jdlIdentifier}{HTML}{001080}   % dark blue (names)
\definecolor{jdlComment}{HTML}{008000}      % green (comments)
